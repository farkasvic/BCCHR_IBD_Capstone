...
ggsave(file = "./figures/mycobiome/abundance_family.png", p, width = 6, height = 4, dpi = 300)
...
ggsave(file = "./figures/mycobiome/abundance_phylum.png", p, width = 6, height = 4, dpi = 300)
...
ggsave(file = "./figures/mycobiome/abundance_genus.png", p, width = 6, height = 4, dpi = 300)
...
ggsave(file = "./figures/mycobiome/abundance_species.png", p, width = 6, height = 4, dpi = 300)
